...
export const topics = [
  {
    "id": "round",
    "title": "轮次流程与轮抽",
    "key": "每轮依次进行准备、轮抽、行动、维持。每次轮抽保留两张并向左传牌，行动阶段最后一张手牌不打出。",
    "bullets": [
  ...
  },
  {
    "id": "trick",
    "title": "谁赢墩，谁先结算？",
    "key": "领出者选择没有圆片的城镇，并打出同色牌或白牌。其他人可出任意牌。同色及白牌中数字最大者赢墩；之后所有人按牌面数字由小到大结算。",
    "bullets": [
    ...
    "figures": [
      {
        ...
        "caption": "争夺红色城镇时，四人分别出红11、红2、白13、黄17。白13赢墩，但结算顺序为2→11→13→17。",
        "fold": false
      }
    ]
  },
  {
    "id": "actions",
    "title": "牌面行动与追加付费",
    "key": "教会、战斗和求婚图标各提供一次基础效果，之后可每付2金币追加一次。扩张必须由对应图标触发，花费5金币。",
    "bullets": [],
    "table": {
      "headers": [
        "图标",
      ...
      "rows": [
        [
          "金币／划掉的金币",
          "获得／归还1金币。只有强制失去金币图标允许在没有金币时改失去2分；连分数也没有则无事发生。"
        ],
        [
          "声望",
          "获得1枚声望，保留在自己面前，用于战斗奖励与终局计分。"
        ],
        [
          "教会十字架",
          "在教会区放1枚圆片，可每付2金币再放1枚。"
        ],
        [
          "战斧",
          "从战斗区拿1枚袭击者，可每付2金币多拿1枚；战斗区已空则无效。"
        ],
        [
          "求婚印章",
          "婚姻轨前进1格，可每付2金币再前进1格；到顶后不能继续前进。"
        ],
        [
          "带5的扩张箭头",
          "可付5金币，占领与自己控制的城镇有道路直接相连、且没有圆片的城镇，不能越过任何中间城镇。"
        ],
        [
          "划掉的维京控制标记",
          "移除版图上一枚维京控制标记，下面圆片的主人重新控制该城镇。"
        ]
      ],
      "icons": [
        "icon-coin.webp",
    ...
    "figures": [
      {
        ...
        "caption": "蓝色城镇可沿路扩张到右侧空城镇。另一方向被紫色城镇隔断，不能跳过它。",
        "fold": false
      }
    ]
  },
  {
    "id": "courtship",
    "title": "婚姻轨：行动结束时不能重叠",
    "key": "先完成整项行动及追加付费，再检查婚姻轨位置。若与他人重叠，向下退到最近的空格；起始格允许多人共存。",
    "bullets": [
    ...
    "figures": [
      {
        ...
        "caption": "Peer前进三格后会与Kate重叠。再付2金币可前进到她前面；不付则必须向后退，越过Georgios，停到最近的空格。",
        "fold": false
      }
    ]
  },
  {
    "id": "battle",
    "title": "维京入侵，再发战斗奖励",
    "key": "战斗区若还留有袭击者，持有袭击者最少的每位玩家各失去一个城镇。随后清空战斗区，并发战利品；即使维京入侵成功仍会发奖励。",
    "bullets": [
  ...
  },
  {
    "id": "church",
    "title": "教会奖励：每档重新比较",
    "key": "先结算唯一领先者，再重新比较剩余领先者，最后检查仍有至少四枚教会圆片的玩家。带修道院的城镇在区域宣称时算作两个城镇。",
    "bullets": [
  ...
  },
  {
    "id": "regions",
    "title": "解锁与宣称区域",
    "key": "先看区域内已控制的城镇总数是否达到门槛：修道院算两个，维京城镇也计入。再由单独控制最多城镇者拿走已翻面的宣称标记；并列则标记留在原处。",
    "bullets": [
  ...
  },
  {
    "id": "princess",
    "title": "丹麦公主：三选一",
    "key": "最后的婚姻获胜者立即在军事支援、建立贸易、直接4分中选一。军事与贸易让维京城镇参与的计分项目不同。",
    "bullets": [],
    "table": {
      "headers": [
        "选择",
      ...
      "rows": [
        [
          "军事支援",
          "你的区域宣称城镇数，以及版图上已翻面宣称标记的终局计分；不增加终局分布区域数。"
        ],
        [
          "建立贸易",
          "你的终局城镇分布区域数；不用于你的宣称标记计分或区域宣称。"
        ],
        [
          "拒绝婚姻",
          "弃掉该牌，立即获得4分。"
  ...
  },
  {
    "id": "scoring",
    "title": "终局计分与平局",
    "key": "最后一次维持结束后，将金币、先手标记、声望、宣称与区域分布得分加到已有分数，总分最高者获胜。",
    "bullets": [
  ...
  },
  {
    "id": "setup",
    "title": "开局设置速查",
    "key": "每人以3金币、1声望、10分开始；各人的起始城镇必须位于不同区域。",
    "bullets": [
...
export const questions = [
  {
    "id": "off-colour",
    "topic": "trick",
    "prompt": "目标为红色城镇，出牌为红11、红2、白13、黄17。谁赢墩，哪张先结算？",
    "options": [
      "黄17赢，红2先结算。",
      "白13赢，红2先结算。",
      "白13赢且先结算。"
    ...
    "answer": 1,
    "explanation": "只有同色和白牌能赢墩，结算则不看胜负，所有牌按数字从小到大进行。"
  },
  {
    "id": "expansion-cost",
    "topic": "actions",
    "prompt": "你有3金币和10分，所选行动有扩张但不给金币。能用分数补足缺少的2金币吗？",
    "options": [
      "可以，失去4分并付3金币。",
      "不行，可选扩张需要实付5金币。",
      "可以，付2分。"
    ...
    "answer": 1,
    "explanation": "仅强制失去金币图标允许在无金币时失分，不能用该例外支付可选购买。"
  },
  {
    "id": "battle-tie",
    "topic": "battle",
    "prompt": "战斗区为空。A持4枚、B持4枚、C持2枚袭击者。A与B获得什么？",
    "options": [
      "各获声望，按声望得分，并归还全部袭击者。",
      "均不获奖励。",
      "各得1分并归还1枚袭击者。"
    ...
    "answer": 2,
    "explanation": "最多者并列时跳过第一档；第二档允许并列，两人各结算一次并各留下3枚袭击者。"
  },
  {
    "id": "claim-tie",
    "topic": "regions",
    "prompt": "你已持有某区域翻面的宣称标记。维持时你与一位对手城镇数并列最多，维京人更少。标记怎么办？",
    "options": [
      "继续持有。",
      "退回版图。",
      "两人各拿一个。"
    ...
    "answer": 0,
    "explanation": "并列时标记留原处，对手必须严格更多才可夺走。"
  },
  {
    "id": "princess-trade",
    "topic": "princess",
    "prompt": "你选择丹麦公主的贸易同盟。维京控制的城镇用于哪项终局计分？",
    "options": [
      "宣称与区域分布都算。",
      "只算区域分布。",
      "只算宣称。"
    ...
    "answer": 1,
    "explanation": "贸易只把维京城镇计入你的分布区域数；宣称相关用途属于另一项军事支援选择。"
  }
];
