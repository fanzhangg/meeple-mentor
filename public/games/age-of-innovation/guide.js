...
function renderScoreCard() {
  return `<section class="checkpoint-score" id="checkpoint-score">
    ...
    <div class="score-actions">
      <div class="score-dial" role="meter" aria-label="${escape(labels.scoreLabel)}" aria-valuemin="0" aria-valuemax="14" aria-valuenow="0">
        <span class="score-dial-value" id="checkpoint-score-text">0/14</span>
      </div>
...
function renderAll() {
  ...
  $('.game-title-row h1').innerHTML = `${escape(labels.title)} <small>(2023)</small>`;
