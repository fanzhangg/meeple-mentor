...
function me(e) {
	return e >= E.UPPER_A && e <= E.UPPER_Z || e >= E.LOWER_A && e <= E.LOWER_Z || D(e);
}
function he(e) {
	return e === E.EQUALS || me(e);
}
var O;
(function(e) {
...
var ge = class {
	constructor(e, t, n) {
		T(this, "decodeTree", void 0), T(this, "emitCodePoint", void 0), T(this, "errors", void 0), T(this, "state", O.EntityStart), T(this, "consumed", 1), T(this, "result", 0), T(this, "treeIndex", 0), T(this, "excess", 1), T(this, "decodeMode", k.Strict), T(this, "runConsumed", 0), this.decodeTree = e, this.emitCodePoint = t, this.errors = n;
	}
	startEntity(e) {
		this.decodeMode = e, this.state = O.EntityStart, this.result = 0, this.treeIndex = 0, this.excess = 1, this.consumed = 1, this.runConsumed = 0;
	}
	write(e, t) {
		switch (this.state) {
			case O.EntityStart: return e.charCodeAt(t) === E.NUM ? (this.state = O.NumericStart, this.consumed += 1, this.stateNumericStart(e, t + 1)) : (this.state = O.NamedEntity, this.stateNamedEntity(e, t));
			case O.NumericStart: return this.stateNumericStart(e, t);
			case O.NumericDecimal: return this.stateNumericDecimal(e, t);
			case O.NumericHex: return this.stateNumericHex(e, t);
			case O.NamedEntity: return this.stateNamedEntity(e, t);
		}
	}
	stateNumericStart(e, t) {
		return t >= e.length ? -1 : (e.charCodeAt(t) | fe) === E.LOWER_X ? (this.state = O.NumericHex, this.consumed += 1, this.stateNumericHex(e, t + 1)) : (this.state = O.NumericDecimal, this.stateNumericDecimal(e, t));
	}
	stateNumericHex(e, t) {
		for (; t < e.length;) {
	...
	stateNumericDecimal(e, t) {
		for (; t < e.length;) {
			let n = e.charCodeAt(t);
			if (D(n)) this.result = this.result * 10 + (n - E.ZERO), this.consumed++, t++;
	...
	stateNamedEntity(e, t) {
		...
		for (; t < e.length;) {
			...
			if (this.treeIndex = ve(n, r, this.treeIndex + Math.max(1, i), a), this.treeIndex < 0) return this.result === 0 || this.decodeMode === k.Attribute && (i === 0 || he(a)) ? 0 : this.emitNotTerminatedNamedEntity();
			if (r = n[this.treeIndex], i = (r & C.VALUE_LENGTH) >> 14, i !== 0) {
				...
				this.decodeMode !== k.Strict && (r & C.FLAG13) === 0 && (this.result = this.treeIndex, this.consumed += this.excess, this.excess = 0);
			}
			t++, this.excess++;
		}
		return -1;
	...
	emitNamedEntityData(e, t, n) {
		...
		switch (this.state) {
			case O.NamedEntity: return this.result !== 0 && (this.decodeMode !== k.Attribute || this.result === this.treeIndex) ? this.emitNotTerminatedNamedEntity() : 0;
			case O.NumericDecimal: return this.emitNumericEntity(0, 2);
			case O.NumericHex: return this.emitNumericEntity(0, 3);
			case O.NumericStart:
				var e;
				return (e = this.errors) == null || e.absenceOfDigitsInNumericCharacterReference(this.consumed), 0;
			case O.EntityStart: return 0;
		}
	}
};
function _e(e) {
	let t = "", n = new ge(e, (e) => t += String.fromCodePoint(e));
	return function(e, r) {
		let i = 0, a = 0;
		for (; (a = e.indexOf("&", a)) >= 0;) {
...
var ye = /* #__PURE__ */ _e(le);
function be(e) {
	return ye(e, k.Strict);
}
//#endregion
...
var Te = /\\([!"#$%&'()*+,\-./:;<=>?@[\\\]^_`{|}~])/g, Ee = RegExp(`${Te.source}|&([a-z#][a-z0-9]{1,31});`, "gi"), De = /^#((?:x[a-f0-9]{1,8}|[0-9]{1,8}))$/i;
function Oe(e, t) {
	if (t.charCodeAt(0) === 35 && De.test(t)) {
...
function R(e) {
	let t = 0;
	for (; t < e.length && Le(e.charCodeAt(t)); t++);
	let n = e.length - 1;
	for (; n >= t && Le(e.charCodeAt(n)); n--);
...
function Be(e, t, n) {
	...
	if (e.charCodeAt(i) === 60) {
		for (i++; i < n;) {
			...
			if (r === 62) return a.pos = i + 1, a.str = j(e.slice(t + 1, i)), a.ok = !0, a;
			if (r === 92 && i + 1 < n) {
				i += 2;
				continue;
			}
	...
	return t === i || o !== 0 ? a : (a.str = j(e.slice(t, i)), a.pos = i, a.ok = !0, a);
}
//#endregion
...
function Ve(e, t, n, r) {
	...
	for (; a < n;) {
		if (i = e.charCodeAt(a), i === o.marker) return o.pos = a + 1, o.str += j(e.slice(t, a)), o.ok = !0, o;
		if (i === 40 && o.marker === 41) return o;
		i === 92 && a + 1 < n && a++, a++;
	}
	return o.can_continue = !0, o.str += j(e.slice(t, a)), o;
}
//#endregion
//#region src/helpers/index.ts
var He = /* @__PURE__ */ t({
	parseLinkDestination: () => Be,
	parseLinkLabel: () => ze,
	parseLinkTitle: () => Ve
}), z = class {
	constructor(e, t, n) {
...
V.code_inline = function(e, t, n, r, i) {
	let a = e[t];
	return `<code${i.renderAttrs(a)}>${M(a.content)}</code>`;
}, V.code_block = function(e, t, n, r, i) {
	let a = e[t];
	return `<pre${i.renderAttrs(a)}><code>${M(e[t].content)}</code></pre>\n`;
}, V.fence = function(e, t, n, r, i) {
	let a = e[t], o = a.info ? j(a.info).trim() : "", s = "", c = "";
	if (o) {
		let e = o.split(/(\s+)/g);
		s = e[0], c = e.slice(2).join("");
	}
	let l;
	if (l = n.highlight && n.highlight(a.content, s, c) || M(a.content), l.indexOf("<pre") === 0) return l + "\n";
	if (o) {
...
var Ue = class {
	constructor() {
		T(this, "rules", Object.assign({}, V));
	}
	renderAttrs(e) {
		let t, n, r;
		if (!e.attrs) return "";
		for (r = "", t = 0, n = e.attrs.length; t < n; t++) r += ` ${M(e.attrs[t][0])}="${M(String(e.attrs[t][1]))}"`;
		return r;
	}
	renderToken(e, t, n) {
		let r = e[t], i = "";
	...
	constructor(e, t, n) {
		T(this, "tokens", []), T(this, "inlineMode", !1), T(this, "Token", z), this.src = e, this.env = n, this.md = t;
	}
}, Ge = /\r\n?/g, Ke = /\0/g;
function qe(e) {
	let t;
...
function $e(e) {
	...
	if (e.md.options.linkify) for (let n = 0, r = t.length; n < r; n++) {
		...
		for (let t = r.length - 1; t >= 0; t--) {
			...
			if (n.type === "html_inline" && (Ze(n.content) && a > 0 && a--, Qe(n.content) && a++), !(a > 0) && n.type === "text" && e.md.linkify.test(n.content)) {
...
var et = /\+-|\.\.|\?\?\?\?|!!!!|,,|--/, tt = /\((c|tm|r)\)/i, nt = /\((c|tm|r)\)/gi, rt = {
	c: "©",
	r: "®",
	tm: "™"
};
...
function at(e) {
	...
	for (let n = e.length - 1; n >= 0; n--) {
		let r = e[n];
		r.type === "text" && !t && (r.content = r.content.replace(nt, it)), r.type === "link_open" && r.info === "auto" && t--, r.type === "link_close" && r.info === "auto" && t++;
	}
}
function ot(e) {
	let t = 0;
	for (let n = e.length - 1; n >= 0; n--) {
		let r = e[n];
		r.type === "text" && !t && et.test(r.content) && (r.content = r.content.replace(/\+-/g, "±").replace(/\.{2,}/g, "…").replace(/([?!])…/g, "$1..").replace(/([?!]){4,}/g, "$1$1$1").replace(/,{2,}/g, ",").replace(/(^|[^-])---(?=[^-]|$)/gm, "$1—").replace(/(^|\s)--(?=\s|$)/gm, "$1–").replace(/(^|[^-\s])--(?=[^-\s]|$)/gm, "$1–")), r.type === "link_open" && r.info === "auto" && t--, r.type === "link_close" && r.info === "auto" && t++;
	}
}
function st(e) {
	let t;
	if (e.md.options.typographer) for (t = e.tokens.length - 1; t >= 0; t--) e.tokens[t].type === "inline" && (tt.test(e.tokens[t].content) && at(e.tokens[t].children), et.test(e.tokens[t].content) && ot(e.tokens[t].children));
}
//#endregion
//#region src/rules_core/smartquotes.ts
var ct = /['"]/, lt = /['"]/g, ut = "’", dt = 1e3;
function ft(e, t, n) {
	for (; e.length > n;) {
		let n = e.pop();
...
function mt(e, t) {
	...
	for (let o = 0; o < e.length; o++) {
		...
		if (ft(r, i, n + 1), s.type !== "text") continue;
		...
		OUTER: for (; u < d;) {
			...
			let _ = I(h) || F(h), v = I(g) || F(g), y = P(h), b = P(g);
			...
			if (p && (n = m ? i.single : i.double, n >= 0 && r[n].level === c)) {
				let e = r[n], c, l;
				m ? (c = t.md.options.quotes[2], l = t.md.options.quotes[3]) : (c = t.md.options.quotes[0], l = t.md.options.quotes[1]), H(a, o, s.index, l), H(a, e.tokenIdx, e.contentPos, c), ft(r, i, n);
				continue OUTER;
			}
			if (f) {
				if (r.length >= dt) return;
				r.push({
					tokenIdx: o,
					contentPos: s.index,
					isSingleQuote: m,
			...
			} else p && m && H(a, o, s.index, ut);
		}
	}
	Object.keys(a).forEach(function(t) {
		let n = Number(t);
		e[n].content = pt(e[n].content, a[t]);
	});
}
function ht(e) {
	if (e.md.options.typographer) for (let t = e.tokens.length - 1; t >= 0; t--) e.tokens[t].type !== "inline" || !ct.test(e.tokens[t].content) || mt(e.tokens[t].children, e);
}
//#endregion
...
function _t(e) {
	...
	for (let e = 0; e < i; e++) {
		...
		for (t = 0; t < a; t++) i[t].type === "text_special" && (i[t].type = "text"), i[t].children && gt(i[t].children);
...
var U = [
	...
	constructor() {
		T(this, "ruler", new B()), T(this, "State", We);
	...
	constructor(e, t, n, r) {
		T(this, "bMarks", []), T(this, "eMarks", []), T(this, "tShift", []), T(this, "sCount", []), T(this, "bsCount", []), T(this, "blkIndent", 0), T(this, "line", 0), T(this, "lineMax", 0), T(this, "tight", !1), T(this, "listIndent", -1), T(this, "parentType", "root"), T(this, "level", 0), T(this, "Token", z), this.src = e, this.md = t, this.env = n, this.tokens = r;
		let i = this.src;
	...
	skipSpaces(e) {
		for (let t = this.src.length; e < t && N(this.src.charCodeAt(e)); e++);
		return e;
	}
	skipSpacesBack(e, t) {
		if (e <= t) return e;
	...
	getLines(e, t, n, r) {
		...
		for (let a = 0, o = e; o < t; o++, a++) {
			...
			for (l = o + 1 < t || r ? this.eMarks[o] + 1 : this.eMarks[o]; c < l && e < n;) {
				...
				if (N(t)) t === 9 ? e += 4 - (e + this.bsCount[o]) % 4 : e++;
...
function St(e, t, n, r) {
	...
	if (s !== 124 && s !== 45 && s !== 58 && !N(s) || o === 45 && N(s)) return !1;
	for (; a < e.eMarks[i];) {
		let t = e.src.charCodeAt(a);
		if (t !== 124 && t !== 45 && t !== 58 && !N(t)) return !1;
		a++;
	}
	let c = W(e, t + 1), l = c.split("|"), u = [];
	...
	if (c = W(e, t).trim(), c.indexOf("|") === -1 || e.sCount[t] - e.blkIndent >= 4) return !1;
	l = xt(c), l.length && l[0] === "" && l.shift(), l.length && l[l.length - 1] === "" && l.pop();
	let d = l.length;
	...
	for (i = t + 2; i < n && !(e.sCount[i] < e.blkIndent); i++) {
		...
		if (r || (c = W(e, i).trim(), !c) || e.sCount[i] - e.blkIndent >= 4 || (l = xt(c), l.length && l[0] === "" && l.shift(), l.length && l[l.length - 1] === "" && l.pop(), y += d - l.length, y > bt)) break;
		if (i === t + 2) {
	...
	for (m = t; m < n; m++) {
		...
		if (e.src.charCodeAt(i++) === 62 && !t) {
			...
			for (s.push(e.bMarks[m]), e.bMarks[m] = i; i < a;) {
				...
				if (N(t)) t === 9 ? o += 4 - (o + e.bsCount[m] + +!!r) % 4 : o++;
				else break;
				i++;
			}
...
function Dt(e, t) {
	...
	return i !== 42 && i !== 45 && i !== 43 || r < n && !N(e.src.charCodeAt(r)) ? -1 : r;
}
function Ot(e, t) {
	...
	return i < r && (a = e.src.charCodeAt(i), !N(a)) ? -1 : i;
}
function kt(e, t) {
	let n = e.level + 2;
...
function At(e, t, n, r) {
	...
	for (e.parentType = "list"; c < n;) {
		...
		if (x) break;
		if (d) {
			if (p = Ot(e, c), p < 0) break;
			o = e.bMarks[c] + e.tShift[c];
		} else if (p = Dt(e, c), p < 0) break;
		if (m !== e.src.charCodeAt(p - 1)) break;
	}
	return s = d ? e.push("ordered_list_close", "ol", -1) : e.push("bullet_list_close", "ul", -1), s.markup = String.fromCharCode(m), g[1] = c, e.line = c, e.parentType = y, l && kt(e, h), !0;
}
//#endregion
...
function jt(e, t, n, r) {
	...
	let g;
	for (i < a && m !== i && h.ok ? (g = h.str, i = h.pos) : (g = "", i = f, o = p); i < a && N(c.charCodeAt(i));) i++;
	if (i < a && c.charCodeAt(i) !== 10 && g) for (g = "", i = f, o = p; i < a && N(c.charCodeAt(i));) i++;
...
function Lt(e, t, n, r) {
	...
	for (; s < G.length && !G[s][0].test(o); s++);
	if (s === G.length) return !1;
	if (r) return G[s][2];
	let c = t + 1, l = G[s][1].test("");
	if (!G[s][1].test(o)) {
		for (; c < n && !(e.sCount[c] < e.blkIndent && (l || !e.isEmpty(c))); c++) if (i = e.bMarks[c] + e.tShift[c], a = e.eMarks[c], o = e.src.slice(i, a), G[s][1].test(o)) {
			o.length !== 0 && c++;
			break;
		}
	}
...
function zt(e, t, n) {
	...
	let c = R(e.getLines(t, s, e.blkIndent, !1));
	e.line = s + 1;
...
function Bt(e, t, n) {
	...
	let o = R(e.getLines(t, a, e.blkIndent, !1));
	e.line = a;
...
var K = [
	...
	constructor() {
		T(this, "ruler", new B()), T(this, "State", yt);
		for (let e = 0; e < K.length; e++) this.ruler.push(K[e][0], K[e][1], { alt: (K[e][2] || []).slice() });
	}
	tokenize(e, t, n) {
	...
	scanDelims(e, t) {
		...
		let c = I(i) || F(i), l = I(s) || F(s), u = P(i), d = P(s), f = !d && (!l || u || c), p = !u && (!c || d || l);
		return {
			can_open: f && (t || !p || c),
			can_close: p && (t || !f || l),
			length: o
...
function qt(e, t) {
	...
	for (; a > i && Kt(e.src.charCodeAt(a - 1));) a--;
	if (a === n || !Gt(e.src.charCodeAt(a))) return !1;
...
function Jt(e, t) {
	...
	for (n++; n < i && N(e.src.charCodeAt(n));) n++;
	return e.pos = n, !0;
}
//#endregion
//#region src/rules_inline/escape.ts
var q = [];
for (let e = 0; e < 256; e++) q.push(0);
...
function Yt(e, t) {
	...
	if (i === 10) {
		for (t || e.push("hardbreak", "br", 0), n++; n < r && (i = e.src.charCodeAt(n), N(i));) n++;
		return e.pos = n, !0;
	}
	if (i === 32) {
		if (!t) {
	...
	if (!t) {
		let t = e.push("text_special", "", 0);
		t.content = i < 256 && q[i] !== 0 ? a : o, t.markup = o, t.info = "escape";
	}
	return e.pos = n + 1, !0;
}
//#endregion
...
function Zt(e, t) {
	...
	if (e.backticksScanned || (e.backticks = Xt(e.src), e.backticksScanned = !0), ((n = e.backticks[s]) == null ? -1 : n) >= a) {
		let n = a, r;
...
function sn(e, t) {
	...
	if (m < d && e.src.charCodeAt(m) === 40) {
		for (l = !1, m++; m < d && (n = e.src.charCodeAt(m), !(!N(n) && n !== 10)); m++);
		if (m >= d) return !1;
		if (c = m, i = e.md.helpers.parseLinkDestination(e.src, m, e.posMax), i.ok) {
			for (o = e.md.normalizeLink(i.str), e.md.validateLink(o) ? m = i.pos : o = "", c = m; m < d && (n = e.src.charCodeAt(m), !(!N(n) && n !== 10)); m++);
			if (i = e.md.helpers.parseLinkTitle(e.src, m, e.posMax), m < d && c !== m && i.ok) for (s = i.str, m = i.pos; m < d && (n = e.src.charCodeAt(m), !(!N(n) && n !== 10)); m++);
		}
		(m >= d || e.src.charCodeAt(m) !== 41) && (l = !0), m++;
	}
	if (l) {
		if (e.env.references === void 0) return !1;
		if (m < d && e.src.charCodeAt(m) === 91 ? (c = m + 1, m = e.md.helpers.parseLinkLabel(e, m), m >= 0 ? r = e.src.slice(c, m++) : m = p + 1) : m = p + 1, r || (r = e.src.slice(f, p)), r = L(r), a = e.env.references[r], !a) return e.pos = u, !1;
		o = a.href, s = a.title;
	}
	if (!t) {
		e.pos = f, e.posMax = p;
...
function cn(e, t) {
	...
	if (a = m + 1, a < f && e.src.charCodeAt(a) === 40) {
		for (a++; a < f && (n = e.src.charCodeAt(a), !(!N(n) && n !== 10)); a++);
		if (a >= f) return !1;
		for (l = a, s = e.md.helpers.parseLinkDestination(e.src, a, e.posMax), s.ok && (u = e.md.normalizeLink(s.str), e.md.validateLink(u) ? a = s.pos : u = ""), l = a; a < f && (n = e.src.charCodeAt(a), !(!N(n) && n !== 10)); a++);
		if (s = e.md.helpers.parseLinkTitle(e.src, a, e.posMax), a < f && l !== a && s.ok) for (c = s.str, a = s.pos; a < f && (n = e.src.charCodeAt(a), !(!N(n) && n !== 10)); a++);
		else c = "";
		if (a >= f || e.src.charCodeAt(a) !== 41) return e.pos = d, !1;
		a++;
	} else {
		if (e.env.references === void 0) return !1;
		if (a < f && e.src.charCodeAt(a) === 91 ? (l = a + 1, a = e.md.helpers.parseLinkLabel(e, a), a >= 0 ? i = e.src.slice(l, a++) : a = m + 1) : a = m + 1, i || (i = e.src.slice(p, m)), i = L(i), o = e.env.references[i], !o) return e.pos = d, !1;
		u = o.href, c = o.title;
	}
	if (!t) {
		r = e.src.slice(p, m);
...
var ln = /^([a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*)$/, un = /^([a-zA-Z][a-zA-Z0-9+.-]{1,31}):([^<>\x00-\x20]*)$/;
function dn(e, t) {
	let n = e.pos;
...
function hn(e, t) {
	...
	if (i !== 33 && i !== 63 && i !== 47 && !mn(i)) return !1;
	let a = e.src.slice(r).match(Ft);
	if (!a) return !1;
	if (!t) {
		let t = e.push("html_inline", "", 0);
		t.content = a[0], fn(t.content) && e.linkLevel++, pn(t.content) && e.linkLevel--;
	}
	return e.pos += a[0].length, !0;
}
//#endregion
//#region src/rules_inline/entity.ts
var gn = /^&#((?:x[a-f0-9]{1,6}|[0-9]{1,7}));/i, _n = /^&([a-z][a-z0-9]{1,31});/i;
function vn(e, t) {
	let n = e.pos, r = e.posMax;
	...
	if (e.src.charCodeAt(n + 1) === 35) {
		...
		if (r) {
			if (!t) {
				...
				n.content = we(t) ? A(t) : A(65533), n.markup = r[0], n.info = "entity";
			}
			return e.pos += r[0].length, !0;
		}
	} else {
		let r = e.src.slice(n).match(_n);
		if (r) {
			let n = be(r[0]);
			if (n !== r[0]) {
				if (!t) {
...
var Sn = [
	...
	["escape", Yt],
	["backticks", Zt],
	["strikethrough", tn.tokenize],
	["emphasis", on.tokenize],
	["link", sn],
	["image", cn],
	["autolink", dn],
	["html_inline", hn],
	...
	["balance_pairs", bn],
	["strikethrough", tn.postProcess],
	["emphasis", on.postProcess],
	["fragments_join", xn]
], wn = class {
	constructor() {
		T(this, "ruler", new B()), T(this, "ruler2", new B()), T(this, "State", Ht);
		for (let e = 0; e < Sn.length; e++) this.ruler.push(Sn[e][0], Sn[e][1]);
		for (let e = 0; e < Cn.length; e++) this.ruler2.push(Cn[e][0], Cn[e][1]);
	}
	skipToken(e) {
...
var jn = {
	...
	constructor(e = {}) {
		...
		this.__opts__ = {
			...jn,
			...n
		}, this.__schemas__ = { ...Dn }, this.re = t || new Tn(), this.re.set({
			...this.__opts__,
	...
	match(e) {
		...
		for (n.lastIndex = 0, this.__opts__.fuzzyLink && this.__schemas__["http:"] && (r = this.re.get_fuzzy_link_search(), r.lastIndex = 0), this.__opts__.fuzzyEmail && this.__schemas__["mailto:"] && (i = this.re.get_fuzzy_mail_host_search(), i.lastIndex = 0, a = this.re.get_mail_name_validator());;) {
			...
			let _ = new Mn(e, g.schema, g.index, g.lastIndex);
	...
	matchAtStart(e) {
		...
		if (!n) return null;
		let r = new Mn(e, t[2], t.index + t[1].length, t.index + t[0].length + n);
...
}, J = 2147483647, Y = 36, Pn = 1, X = 26, Fn = 38, In = 700, Ln = 72, Rn = 128, zn = "-", Bn = /^xn--/, Vn = /[^\0-\x7F]/, Hn = /[\x2E\u3002\uFF0E\uFF61]/g, Un = {
	overflow: "Overflow: input needs wider integers to process",
	"not-basic": "Illegal input >= 0x80 (not a basic code point)",
	"invalid-input": "Invalid input"
}, Wn = 35, Z = Math.floor, Gn = String.fromCharCode;
function Q(e) {
	throw RangeError(Un[e]);
}
function Kn(e, t) {
	let n = [], r = e.length;
	for (; r--;) n[r] = t(e[r]);
...
function qn(e, t) {
	let n = e.split("@"), r = "";
	n.length > 1 && (r = n[0] + "@", e = n[1]), e = e.replace(Hn, ".");
	let i = Kn(e.split("."), t).join(".");
	return r + i;
}
function Jn(e) {
...
var Yn = (e) => String.fromCodePoint(...e), Xn = function(e) {
	return e >= 48 && e < 58 ? 26 + (e - 48) : e >= 65 && e < 91 ? e - 65 : e >= 97 && e < 123 ? e - 97 : Y;
}, Zn = function(e, t) {
	return e + 22 + 75 * (e < 26) - ((t != 0) << 5);
}, Qn = function(e, t, n) {
	let r = 0;
	for (e = n ? Z(e / In) : e >> 1, e += Z(e / t); e > 455; r += Y) e = Z(e / Wn);
	return Z(r + 36 * e / (e + Fn));
}, $n = function(e) {
	let t = [], n = e.length, r = 0, i = Rn, a = Ln, o = e.lastIndexOf(zn);
	o < 0 && (o = 0);
	...
	for (let s = o > 0 ? o + 1 : 0; s < n;) {
		...
		for (let t = 1, i = Y;; i += Y) {
			s >= n && Q("invalid-input");
			let o = Xn(e.charCodeAt(s++));
			o >= Y && Q("invalid-input"), o > Z((J - r) / t) && Q("overflow"), r += o * t;
			let c = i <= a ? Pn : i >= a + X ? X : i - a;
			if (o < c) break;
			let l = Y - c;
			t > Z(J / l) && Q("overflow"), t *= l;
		}
		let c = t.length + 1;
		a = Qn(r - o, c, o == 0), Z(r / c) > J - i && Q("overflow"), i += Z(r / c), r %= c, t.splice(r++, 0, i);
	}
	return String.fromCodePoint(...t);
}, er = function(e) {
	let t = [];
	e = Jn(e);
	let n = e.length, r = Rn, i = 0, a = Ln;
	for (let n of e) n < 128 && t.push(Gn(n));
	let o = t.length, s = o;
	for (o && t.push(zn); s < n;) {
		let n = J;
		...
		for (let n of e) if (n < r && ++i > J && Q("overflow"), n === r) {
			let e = i;
			for (let n = Y;; n += Y) {
				let r = n <= a ? Pn : n >= a + X ? X : n - a;
				if (e < r) break;
				let i = e - r, o = Y - r;
				t.push(Gn(Zn(r + i % o, 0))), e = Z(i / o);
			}
			t.push(Gn(Zn(e, 0))), a = Qn(i, c, s === o), i = 0, ++s;
		}
		++i, ++r;
	}
	return t.join("");
	...
	toASCII: function(e) {
		return qn(e, function(e) {
			return Vn.test(e) ? "xn--" + er(e) : e;
		});
	},
	toUnicode: function(e) {
		return qn(e, function(e) {
			return Bn.test(e) ? $n(e.slice(4).toLowerCase()) : e;
		});
	}
}, nr = {
	default: {
...
}, rr = /^(vbscript|javascript|file|data):/, ir = /^data:image\/(gif|png|jpeg|webp);/, ar = [
	"http:",
	"https:",
	"mailto:"
], $ = class {
	...
	normalizeLink(e) {
		let t = b(e, !0);
		if (t.hostname && (!t.protocol || ar.indexOf(t.protocol) >= 0)) try {
			t.hostname = tr.toASCII(t.hostname);
		} catch (e) {}
	...
	normalizeLinkText(e) {
		let t = b(e, !0);
		if (t.hostname && (!t.protocol || ar.indexOf(t.protocol) >= 0)) try {
			t.hostname = tr.toUnicode(t.hostname);
		} catch (e) {}
		return i(c(t), i.defaultChars + "%");
	}
	constructor(...e) {
		T(this, "inline", new wn()), T(this, "block", new Vt()), T(this, "core", new vt()), T(this, "renderer", new Ue()), T(this, "linkify", new Nn()), T(this, "utils", xe), T(this, "helpers", Object.assign({}, He));
		let [t, n] = e;
	...
	configure(e) {
		...
		if (typeof e == "string") {
			let n = e;
			if (t = nr[n], !t) throw Error(`Wrong 'markdown-it' preset "${n}", check name`);
		} else t = e;
...
T($, "Token", z), T($, "Ruler", B), T($, "Renderer", Ue), T($, "ParserCore", vt), T($, "StateCore", We), T($, "ParserBlock", Vt), T($, "StateBlock", yt), T($, "ParserInline", wn), T($, "StateInline", Ht);
//#endregion
//#region src/index.ts
var or = Se($);
//#endregion
