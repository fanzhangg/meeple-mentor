...
import * as en from '../public/games/clans-of-caledonia/guide-data.en.js';
import * as zh from '../public/games/clans-of-caledonia/guide-data.js';
import {copy} from '../public/games/clans-of-caledonia/guide-copy.js';
import {createQuizSession} from '../public/games/clans-of-caledonia/guide-model.js';
import {examplesFor} from '../public/games/clans-of-caledonia/guide-examples.js';
...
test('all images, localized captions and both library routes resolve', () => {
  ...
  for (const lang of [en,zh]) for (const topic of lang.topics) for (const ex of examplesFor(topic)) {
    ...
    assert.ok(existsSync(new URL(`guide-assets/clans-of-caledonia/${ex.image}`,root)));
  }
  for (const name of ['content/games/index.json','public/data/games.json']) {
    ...
    const item=list.find(g=>g.slug==='clans-of-caledonia');
